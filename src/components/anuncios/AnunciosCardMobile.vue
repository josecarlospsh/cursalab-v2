  ...
  >
    <div class="flex flex-wrap relative" :class="[viewList ? 'w-full' : '']">
      ...
      >
        ...
        <div class="p-6 xl:pb-24" :class="[viewList ? 'w-3/4' : 'w-full']">
          <div
            class="lg:h-16 lg:text-overflow-2 text-gray-600 font-bold text-xl md:text-2xl leading-6 md:leading-8 mb-4"
          >{{title}}</div>
          <p class="lg:text-overflow-3 text-gray-600 text-base mb-8">{{description}}</p>
